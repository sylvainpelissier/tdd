...
class Definitions:
    ...
    def datatype_get(self, perimeter, id):
        try:
            ...
            return Group("Unknown group"), Definition(
                id, "Unknown " + id, 0, None, String
            )
...
c40 = Definitions(
    Perimeter(
        ...
        Doctype(
            "17",
            "Justificatif d’Asile",
            "Attestation de fin de droit à l’allocation pour demandeur d’asile (ADA)",
        ),
        Doctype(
            "18",
        ...
        Doctype(
            "20", "Justificatif fiscal", "Déclarations de cession de droits sociaux"
        ),
        Doctype("21", "Justificatif fiscal", "Attestation 2041-ASK"),
        Doctype(
            "22",
            "Justificatif juridique/judiciaire",
        ...
        Doctype(
            ...
            "Certificat de conformité sûreté aéroportuaire",
        ),
        Doctype(
            "27",
            "Justificatif de ressources",
            "Avis de Situation Déclarative à l’Impôt sur les Revenus (V3)",
        ),
        Doctype(
            "28", "Justificatif de ressources", "Avis d’impôt sur les Revenus (V2)"
        ),
        Doctype(
            "29", "Justificatif d’emploi", "Attestation d’Activité Professionnelle"
        ),
        ...
        Doctype(
            "A6", "Justificatif d’activité", "Carte Professionnelle Sapeur-Pompier"
        ),
        Doctype(
            "A7", "Justificatif de véhicule", "Certificat de qualité de l’air (V2)"
        ),
        Doctype(
            "A8", "Certificat d’immatriculation", "Certificat de cession électronique"
        ),
        ...
        Doctype(
            "C1", "Autorisations douanière", "Renseignement Tarifaire Contraignant"
        ),
        Doctype(
            "C2",
            "Autorisations douanière",
            "Accord Préalable pour le transfert d’armes",
        ),
        Doctype(
            "C3",
            "Autorisations douanière",
            "Permis de transfert d’armes à feu et de munitions",
        ),
        Doctype(
            "C4",
            "Autorisations douanière",
        ...
        Doctype(
            "C6",
            "Autorisations douanière",
            "Agrément de transfert d’armes à feu et de munitions",
        ),
        ...
        Group(
            "Identifiants de données complémentaires du code 2D-DOC",
            ...
            Definition(
                "05", "Version de l’application de composition", 0, None, String
            ),
            Definition(
                "06",
        ...
        Group(
            "Identifiants de données propres aux factures",
            Definition(
                "10",
            ...
            Definition(
                "17", "Nom de la personne destinataire de la facture", 0, 38, StringAZSp
            ),
            Definition("18", "Numéro de la facture", 0, None, StringAZ09Sp),
            Definition("19", "Numéro de client", 0, None, StringAZ09Sp),
            Definition("1A", "Numéro du contrat", 0, None, StringAZ09Sp),
            Definition(
                "1B", "Identifiant du souscripteur du contrat", 0, None, StringAZ09Sp
            ),
            ...
            Definition(
                "1K", "Prénom du co-bénéficiaire de la prestation", 0, 38, StringAZSp
            ),
            Definition(
                "1L", "Nom du co-bénéficiaire de la prestation", 0, 38, StringAZSp
            ),
            Definition(
                "1M",
            ...
            Definition(
                "1O", "Prénom du co-destinataire de la facture", 0, 38, StringAZSp
            ),
        ...
        Group(
            "Identifiants de données bancaires",
        ...
        Group(
            "Identifiants de données fiscales",
            ...
            Definition(
                "4U", "Dénomination sociale de l’employeur", 0, 38, StringAZ09Sp
            ),
        ...
        Group(
            "Identifiants de données relatives à l’activité professionnelle",
            ...
            Definition(
                "5H", "Code postal ou code cedex de l’employeur", 5, 5, Numeric0
            ),
            Definition(
                "5I",
            ...
            Definition(
                "5K", "Identifiant Cotisant Prestations Sociales", 0, 50, StringAZ09Sp
            ),
            Definition("5L", "Numéro de SIRET ou RNA", 9, 14, StringAZ09),
            Definition("5M", "Dénomination sociale", 0, 38, StringAZ09Sp),
            Definition(
                "5N", "Numéro de dossier d'autorisation de travail", 21, 21, Numeric0
            ),
        ...
        Group(
            "Identifiants de données relatives aux titres d’identité",
            ...
            Definition(
                "6K", "Numéro de la demande de document étranger", 19, 19, Numeric0
            ),
            ...
            Definition(
                "6S", "Ligne 2 de l‘adresse postale du domicile", 0, 38, StringAZ09Sp
            ),
            Definition(
                "6T", "Ligne 3 de l‘adresse postale du domicile", 0, 38, StringAZ09Sp
            ),
            Definition(
                "6U", "Ligne 4 de l‘adresse postale du domicile", 0, 38, StringAZ09Sp
            ),
            Definition(
                "6V", "Ligne 5 de l‘adresse postale du domicile", 0, 38, StringAZ09Sp
            ),
            Definition(
                "6W",
            ...
            Definition(
                "6X", "Commune de l‘adresse postale du domicile", 0, 32, StringAZSp
            ),
            Definition(
                "6Y", "Code pays de l‘adresse postale du domicile", 2, 2, Iso3166_2
            ),
            Definition(
                "6Z",
                "Numéro d'étranger de l'autorisation de travail",
                9,
                11,
                StringAZ09,
            ),
        ...
        Group(
            "Identifiants de données relatives aux données de santé",
            ...
            Definition(
                "7N", "Lieu de validation du certificat de décès", 0, 128, StringAZ09Sp
            ),
        ...
        Group(
            "Identifiants relatifs aux activités professionnelles",
        ...
        Group(
            "Identifiants relatifs aux données juridiques/judiciaires",
            Definition("90", "Identité de l‘huissier de justice", 0, 38, StringAZSpSl),
            Definition(
                "91", "Identité ou raison sociale du demandeur", 0, 38, StringAZSpSl
            ),
            Definition(
                "92", "Identité ou raison sociale du destinataire", 0, 38, StringAZSpSl
            ),
            Definition(
                "93",
        ...
        Group(
            ...
            Definition(
                "A0", "Pays ayant émis l’immatriculation du véhicule", 2, 2, Iso3166_2
            ),
            ...
            Definition(
                "A7", "Taux d’émission de CO2 du véhicule (en g/km)", 3, 3, HexInt
            ),
            Definition(
                "A8",
            ...
            Definition(
                "AA", "Date de première immatriculation du véhicule", 8, 8, JJMMAAAA
            ),
            ...
            Definition(
                "AF", "Nombre de points retirés lors de l’infraction", 1, 1, Base36
            ),
            ...
            Definition(
                "AU",
                "Ligne 2 de l'adresse postale du propriétaire",
                0,
                38,
                StringAZ09Sp,
            ),
            Definition(
                "AV",
                "Ligne 3 de l'adresse postale du propriétaire",
                0,
                38,
                StringAZ09Sp,
            ),
            Definition(
                "AW",
                "Ligne 4 de l'adresse postale du propriétaire",
                0,
                38,
                StringAZ09Sp,
            ),
            Definition(
                "AX",
                "Ligne 5 de l'adresse postale du propriétaire",
                0,
                38,
                StringAZ09Sp,
            ),
            Definition(
                "AY",
                "Code postal ou code cedex de l'adresse postale du propriétaire",
                5,
                5,
                Numeric0,
            ),
            Definition(
                "AZ", "Commune de l'adresse postale du propriétaire", 0, 32, StringAZSp
            ),
        ),
        Group(
            "Identifiants de données pour les justificatifs académiques",
            ...
            Definition(
                "BD", "Niveau du diplôme selon la classification CEC", 1, 1, Numeric
            ),
            ...
            Definition(
                "BK",
                "Numéro de l‘Attestation de versement de la CVE",
                14,
                14,
                StringAZ09Dash,
            ),
        ...
        Group(
            "Identifiants de données relatives au certificat de cession électronique",
            ...
            Definition(
                "CC", "Date et heure d‘enregistrement dans le SIV", 12, 12, JJMMAAAAHHMM
            ),
        ),
        Group(
            "Identifiants de données relatives aux autorisations douanières",
            ...
            Definition(
                "HE", "Code postal et commune de l'expéditeur", 0, 38, StringAZSp
            ),
            Definition("HF", "Adresse du destinataire", 0, 38, StringAZSp),
            Definition(
                "HG", "Code postal et commune du destinataire", 0, 38, StringAZSp
            ),
            Definition(
                "HH", "Numéro d’identification du transport", 0, 20, StringAZ09DashSl
            ),
            Definition(
                "HI",
                "Numéro, extension et libellé de voie de l'adresse de résidence",
                0,
                38,
                StringAZSp,
            ),
        ...
        Group(
            "Identifiants de données relatives aux résultats des tests virologiques",
        ...
        Group(
            "Identifiants de données relatives à une attestation vaccinale",
            ...
            Definition(
                "L7", "Rang du dernier état de vaccination effectué", 1, 1, Numeric0
            ),
            Definition(
                "L8", "Nombre de doses attendues pour un cycle complet", 1, 1, Numeric0
            ),
            Definition(
                "L9", "Date du dernier état du cycle de vaccination", 8, 8, JJMMAAAA
            ),
            Definition("LA", "Etat du cycle de vaccination", 2, 2, StringAZ),
        ),
        Group(
            "Identifiants de données relatives à l’asile",
            ...
            Definition(
                "G4", "Somme des montants versés au titre de l'ADA", 0, 10, Decimal
            ),
            Definition(
                "G5", "Information de la Direction Territoriale", 0, 45, StringAZ09
            ),
        ),
        Group(
            "Identifiants de données relatives au permis de conduire",
            ...
            Definition(
                "E5", "Etat du permis de conduire du conducteur", 2, 2, Numeric0
            ),
            Definition(
                "E6", "Catégories présentes de permis de conduire", 0, 65, StringAZ09Sp
            ),
        ...
        Group(
            "Identifiants de données relatives au caducée infirmier",
